...
export function CodeEditor() {
  ...
  return (
    <div className="relative w-full max-w-lg">
      ...
      <div className="absolute -inset-4 rounded-2xl bg-gradient-to-r from-[#c6ff3a]/20 via-[#84cc16]/20 to-[#c6ff3a]/20 blur-2xl" />
      ...
      <div className="relative overflow-hidden rounded-xl border border-white/10 bg-[#0f0f0f] shadow-2xl">
        ...
        <div className="p-5">
          <div className="flex items-start gap-3">
            <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-[#c6ff3a] to-[#84cc16]">
            ...
            <div className="flex-1">
              <p className="font-mono text-sm text-white/80">
                {displayedText}
                <span className={`ml-0.5 inline-block h-4 w-0.5 bg-[#c6ff3a] ${isTypingComplete ? 'animate-pulse' : 'animate-[blink_0.8s_infinite]'}`} />
              </p>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="flex h-48">
            ...
            <div className="w-12 shrink-0 border-r border-white/5 bg-white/[0.02] p-2">
              <div className="mb-3 h-6 w-6 rounded-lg bg-gradient-to-br from-[#c6ff3a] to-[#84cc16]" />
              {[...Array(4)].map((_, i) => (
              ...
              <div className="rounded-lg bg-white/5 p-2">
                ...
                <div className="flex h-16 items-end gap-1">
                  {[40, 65, 45, 80, 55, 70, 60, 85, 50].map((h, i) => (
                    <motion.div 
                      key={i} 
                      className="flex-1 rounded-t bg-gradient-to-t from-[#c6ff3a]/50 to-[#84cc16]/50"
                      initial={{ height: 0 }}
                      animate={{ height: `${h}%` }}
          ...
          >
            <svg className="h-3 w-3 text-[#c6ff3a]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
            </svg>
