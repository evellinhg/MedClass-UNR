...
export function WhatsappFloatButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-black/20 transition-transform hover:scale-110 hover:shadow-[0_0_20px_4px_rgba(37,211,102,0.6)]"
    >
