...
const pt = {
  ...
  treinamentos: {
    areaLabel: {
      ...
      "Medicina da Família e Comunidade": "Medicina da Família e Comunidade",
    } as Record<string, string>,
    dificuldadeLabel: {
      aleatorio: "Aleatório",
      "fácil": "Fácil",
    ...
    modoEstudoTitulo: "Modo Estudo",
    modoEstudoSubtitulo: "Aprenda no seu ritmo",
    modoEstudoItem1: "Feedback imediato com explicação de cada questão",
    modoEstudoItem2: "Escolha área, dificuldade e prova livremente",
    modoEstudoItem3: "Sem pressão de tempo — cronômetro é opcional",
    iniciarEstudo: "Iniciar Estudo",
    ...
    nomePlaceholder: "Ex: Clínica Médica - Revisão",
    areaLabelNenhuma: "Área (nenhuma selecionada = todas)",
    todas: "Todas",
    nivel: "Nível",
    ...
    nenhumTreinamento: "Nenhum treinamento criado ainda. Escolha o Modo Estudo ou crie um Simulado para começar.",
  ...
  practiceLauncher: {
    dialogTitulo: "Configurar treino de questões",
    ...
    areaLabelTodas5: "Área (nenhuma selecionada = todas as 5 juntas)",
    ...
    labelAleatorias: (prova: string) => `Questões aleatórias · ${prova}`,
  },
  simuladoPlayer: {
...
const es: typeof pt = {
  ...
  treinamentos: {
    areaLabel: {
      "Pediatria": "Pediatría",
      "Ginecologia e Obstetrícia": "Ginecología y Obstetricia",
      "Cirurgia": "Cirugía",
      "Clínica Médica": "Clínica Médica",
      "Medicina da Família e Comunidade": "Medicina Familiar y Comunitaria",
    } as Record<string, string>,
    dificuldadeLabel: {
      aleatorio: "Aleatorio",
      "fácil": "Fácil",
    ...
    modoEstudoTitulo: "Modo Estudio",
    modoEstudoSubtitulo: "Aprendé a tu ritmo",
    modoEstudoItem1: "Feedback inmediato con explicación de cada pregunta",
    modoEstudoItem2: "Elegí materia, dificultad y examen libremente",
    modoEstudoItem3: "Sin presión de tiempo — el cronómetro es opcional",
    iniciarEstudo: "Iniciar Estudio",
    ...
    nomePlaceholder: "Ej: Clínica Médica - Repaso",
    areaLabelNenhuma: "Materia (ninguna seleccionada = todas)",
    todas: "Todas",
    nivel: "Nivel",
    ...
    nenhumTreinamento: "Todavía no creaste ningún entrenamiento. Elegí el Modo Estudio o creá un Simulacro para empezar.",
    badgeSimulado: "Simulacro",
    badgeEstudo: "Estudio",
    concluido: "Completado",
    emAndamento: "En curso",
    todasAsAreas: "Todas las materias",
  ...
  practiceLauncher: {
    dialogTitulo: "Configurar entrenamiento de preguntas",
    ...
    areaLabelTodas5: "Materia (ninguna seleccionada = todas las 5 juntas)",
    questoesPlanoGratuito: (remaining: number, limit: number) =>
    ...
    fechar: "Cerrar",
    iniciarTreino: "Iniciar Entrenamiento",
    labelAleatorias: (prova: string) => `Preguntas aleatorias · ${prova}`,
  },
  simuladoPlayer: {
