...
const es: typeof pt = {
  ...
  feedback: {
    ...
    anexoAjuda: "Imágenes, videos o documentos — hasta 20MB.",
    anexoSelecionar: "Elegir archivo",
    anexoTrocar: "Cambiar archivo",
    anexoRemover: "Quitar",
    anexoEnviando: "Subiendo adjunto...",
    anexoErroTamanho: "El archivo es muy grande. El límite es 20MB.",
