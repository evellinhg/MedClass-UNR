    ...
    mockEntries: [
      {
        ...
        materia: "Nutrição",
        mensagem: "Qual é a diferença entre insuficiência cardíaca sistólica e diastólica?",
        data: "2025-01-15",
      },
      {
        id: "2",
        tipo: "sugestao" as const,
        materia: "Cirurgia de 5º ano",
        mensagem: "Seria interessante adicionar mais casos clínicos práticos sobre hérnia de disco.",
        data: "2025-01-10",
      },
      {
        id: "3",
        ...
        mensagem: "A resposta da questão 42 está marcada como errada, mas a resposta A também é correta.",
        data: "2025-01-05",
      },
    ],
  },
    ...
    mockEntries: [
      {
        ...
        tipo: "duvida" as const,
        materia: "Nutrición",
        mensagem: "¿Cuál es la diferencia entre insuficiencia cardíaca sistólica y diastólica?",
        data: "2025-01-15",
      },
      {
        id: "2",
        tipo: "sugestao" as const,
        materia: "Cirugía de 5º año",
        mensagem: "Estaría bueno agregar más casos clínicos prácticos sobre hernia de disco.",
        data: "2025-01-10",
      },
      {
        id: "3",
        tipo: "erro" as const,
        materia: "Clínica Médica",
        mensagem: "La respuesta de la pregunta 42 está marcada como incorrecta, pero la respuesta A también es correcta.",
        data: "2025-01-05",
      },
    ],
  },
