...
console.log("Podando:", updates.length)
...
console.log(`\nFinal: mais_longa=${aindaLonga} (${(100*aindaLonga/pos.length).toFixed(1)}%), mais_curta=${aindaCurta} (${(100*aindaCurta/pos.length).toFixed(1)}%), equilibrada=${ok2}`)
